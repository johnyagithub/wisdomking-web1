	...
	<div id="content" class="content">
		...
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb container">
				...
				<li class="breadcrumb-item active" aria-current="page">จริยธรรม</li>
			</ol>
		</nav>
		...
		<section class="pb-4">
			<div class="container">
				...
				<div class="--detail">
					<img
						src="https://www.wisdomking.or.th/files/media_manager/12075f8459499dd19b4bc0eed7ccbf39/About_Us/ITA/66/ethics/0001.jpg"
						class="mw-100 mx-auto d-block rounded my-3" alt="">
					<img
						src="https://www.wisdomking.or.th/files/media_manager/12075f8459499dd19b4bc0eed7ccbf39/About_Us/ITA/66/ethics/0002.jpg"
						class="mw-100 mx-auto d-block rounded my-3" alt="">

					<br>
					<p class="text-center">ช่องทางการติดต่อสอบถาม ให้คำปรึกษา ตอบคำถามทางจริยธรรม</p>
