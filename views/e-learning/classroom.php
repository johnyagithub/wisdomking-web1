				...
				<div class="row">
					<div class="col-md-5 col-xl-4">
						...
						<div class="box-Course-syllabus d-block nav nav-tabs border-bottom-0" role="tablist">
							<div class="item align-items-center finished" id="nav-1-tab" data-toggle="tab" data-target="#nav-1" type="button" role="tab"
							...
							<div class="item align-items-center active" id="nav-2-tab" data-toggle="tab" data-target="#nav-2" type="button" role="tab"
							...
							<div class="item align-items-center" id="nav-3-tab" data-toggle="tab" data-target="#nav-3" type="button" role="tab"
								aria-controls="nav-3" aria-selected="true">
								<div class="-icon">
									<img src="../../public/images/play-circle-fill.png" alt="">
								</div>
								<div class="text">
							...
							<div class="item align-items-center" id="nav-4-tab" data-toggle="tab" data-target="#nav-4" type="button" role="tab"
								aria-controls="nav-4" aria-selected="true">
								<div class="-icon">
					...
					<div class="box-Course-syllabus-tab col tab-content">
						<div class="tab-pane fade" id="nav-1" role="tabpanel" aria-labelledby="nav-1-tab">
							<div class="-video">
								<h4 class="text-center font-weight-light"><b>บทที่ 1 :</b> บทแนะนำรายวิชา</h4>
								<div class="img">
						...
						<div class="tab-pane fade show active" id="nav-2" role="tabpanel" aria-labelledby="nav-2-tab">
							<div class="-video">
								<h4 class="text-center font-weight-light"><b>บทที่ 2 :</b> บทแนะนำรายวิชา</h4>
								<div class="img">
									<div class="btn-play-video">
										<button type="button" class="btn rounded-circle" data-modal="#video" data-type="youtube"
											data-src="https://www.youtube.com/embed/6VStThKU2cU?autoplay=1&amp;loop=1&amp;autopause=0"></button>
						...
						<div class="tab-pane fade" id="nav-3" role="tabpanel" aria-labelledby="nav-3-tab">
							<div class="-video">
								<h4 class="text-center font-weight-light"><b>บทที่ 3 :</b> บทแนะนำรายวิชา</h4>
								<div class="img">
									<div class="btn-play-video">
										<button type="button" class="btn rounded-circle" data-modal="#video" data-type="youtube"
											data-src="https://www.youtube.com/embed/6VStThKU2cU?autoplay=1&amp;loop=1&amp;autopause=0"></button>
						...
						<div class="tab-pane fade" id="nav-4" role="tabpanel" aria-labelledby="nav-4-tab">
							<div class="-video">
								<h4 class="text-center font-weight-light"><b>บทที่ 4 :</b> บทแนะนำรายวิชา</h4>
								<div class="img">
									<div class="btn-play-video">
										<button type="button" class="btn rounded-circle" data-modal="#video" data-type="youtube"
											data-src="https://www.youtube.com/embed/6VStThKU2cU?autoplay=1&amp;loop=1&amp;autopause=0"></button>
