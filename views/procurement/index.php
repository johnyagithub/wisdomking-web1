			...
			<div class="container">
				...
				<div class="table-responsive">
					<table class="table table-striped text-center" style="min-width: 1000px;">
						...
						<tbody>
							<tr class="Status1">
								<td class="text-left">ประกาศ เรื่องยกเลิกประกาศ ประกวดราคาจ้างก่อสร้างโรงจอดรถอาคารอำนวยการ จำนวน 1 งาน
							...
							<tr class="Status2">
								<td class="text-left">ใบสั่งซื้อชุดโปรแกรมจัดการสำนักงาน แบบที่ 1 ที่มีลิขสิทธิ์ถูกต้องตามกฎหมาย
							...
							<tr class="Status2">
								<td class="text-left">รับสมัครเจ้าหน้าที่จ้างเหมาบริการปฏิบัติด้านการประสานงานและจัดนิทรรศการสัญจร</th>
								<td>ใบสั่งจ้าง/ใบสั่งซื้อ</td>
								<td>24-May-2567</td>
								<td>24-May-2567</td>
								<td>
							...
							<tr class="Status4">
								<td class="text-left">ประกาศ เรื่องเปลี่ยนแปลงประกาศรายชื่อผู้ชนะการเสนอราคา</th>
								<td>อื่นๆ</td>
								<td>24-May-2567</td>
								<td>24-May-2567</td>
								<td>
