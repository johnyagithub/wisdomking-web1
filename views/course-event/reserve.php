		...
		<section class="py-4">
			<div class="container">
				...
				<div id="join-project" data-status="2">
					...
					<!-- status2 -->
					<div class="b-status2">
						<form id="form-course" action="#" class="my-4" novalidate>
							<div class="box-form-course">
								<div class="d-flex align-items-start pt-3">
									<div class="-number">1</div>
									<div class="w-100">
										<h4 class="text-gradient">หลักสูตร "ตามรอยพ่อ"</h4>
										<div class="d-lg-flex">
											<b>ระยะเวลาเรียน :</b>
								...
								<div class="-paper">
									...
									<div class="group-choose3">
										<h6>*3. เลือกเรียนรู้พิพิธภัณฑ์ในอาคาร <b class="text-danger">ได้ 1 พิพิธภัณฑ์ 3 ฐานการเรียนรู้</b></h6>
										<!-- 3.1 -->
							...
							<div class="form-row justify-content-center mt-4 border-top pt-4">
								<div class="col-6 col-md-4 col-lg-3 px-1">
									<button type="reset" class="btn btn-light border bg-white rounded-pill w-100" onclick="$('.form-check-input').prop('disabled', false);">ยกเลิก</button>
								</div>
								<div class="col-6 col-md-4 col-lg-3 px-1">
					...
					<div class="b-status3">
						3
						<form id="form-course2" action="#" class="my-4" novalidate>
							<div class="form-row justify-content-center mt-4 border-top pt-4">
								<div class="col-6 col-md-4 col-lg-3 px-1">
									<button type="button" class="btn btn-light border bg-white rounded-pill w-100" onclick="$('#join-project').attr('data-status', '2');">ย้อนกลับ</button>
								</div>
								<div class="col-6 col-md-4 col-lg-3 px-1">
									<button type="submit" class="btn btn-style w-100">ดำเนินการต่อ</button>
								</div>
					...
					<div class="b-status4">
						...
						<div class="form-row justify-content-center mt-4 border-top pt-4">
							<div class="col-6 col-md-4 col-lg-3 px-1">
								<button type="button" class="btn btn-light border bg-white rounded-pill w-100" onclick="$('#join-project').attr('data-status', '3');">ย้อนกลับ</button>
							</div>
							<div class="col-6 col-md-4 col-lg-3 px-1">
								<button type="button" class="btn btn-style w-100" onclick="$('#form-course, #form-course2').submit();">ดำเนินการต่อ</button>
							</div>
						</div>
					</div>
