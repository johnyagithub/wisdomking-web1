	...
	<div id="content" class="content">
		...
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb container bg-white">
				...
				<li class="breadcrumb-item active" aria-current="page">ขั้นตอนการให้บริการจองเข้าชมและเรียนรู้</li>
			</ol>
		</nav>
		...
		<section class="pb-4">
			<div class="container">
				<div class="--detail">
					<h3 class="head mb-4 text-center">ขั้นตอนการให้บริการจองเข้าชมและเรียนรู้</h3>
