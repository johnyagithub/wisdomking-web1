	...
	<div id="content" class="content">
		...
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb container bg-white">
				...
				<li class="breadcrumb-item active" aria-current="page">1 ไร่ มั่งคั่ง ยั่งยืน</li>
			</ol>
		</nav>
		...
		<section class="pb-4">
			<div class="container">
				<div class="mx-auto mb-5" style="max-width: 1000px;">
					<h4 class="head mb-4 text-center">1 ไร่ มั่งคั่ง ยั่งยืน</h4>
				...
				<div class="--detail">
					...
					<div class="px-lg-5">
						<b>โครงการ “1 ไร่ มั่งคั่ง ยั่งยืน</b>
						<p>สำนักงานพิพิธภัณฑ์เกษตรเฉลิมพระเกียรติพระบาทสมเด็จพระเจ้าอยู่หัว (องค์การมหาชน)
							ดำเนินการเผยแพร่องค์ความรู้เกษตรทฤษฎีใหม่ ประยุกต์ ทำนา 1 ไร่ ได้เงิน 1 แสน ซึ่งได้ดำเนินการแล้วจำนวน 12
							รุ่น ตั้งแต่เดือนกันยายน 2554 จนถึงเดือน มกราคม 2562 นั้น จึง มีการพัฒนา
							ต่อยอดโครงการเกษตรทฤษฎีใหม่ประยุกต์ ทำนา 1 ไร่ ได้เงิน 1 แสน เป็นโครงการ 1 ไร่ มั่งคั่ง ยั่งยืน เพื่อสนอง
							พระราชปณิธาน สืบสาน รักษา ต่อยอด และเผยแพร่พระเกียรติคุณและพระอัจฉริยภาพพระบาทสมเด็จพระบรมชนกาธิเบศร
							มหาภูมิพลอดุลยเดชมหาราช บรมนาถบพิตร ด้านการเกษตร ตลอดจนน้อมนำนวัตกรรมเกษตรเศรษฐกิจพอเพียง พัฒนายกระดับและ
							ขยายผลเรื่องปรัชญาเศรษฐกิจพอเพียงด้านการเกษตร</p>
