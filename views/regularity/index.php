	...
	<div id="content" class="content">
		...
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb container bg-white">
				...
				<li class="breadcrumb-item active" aria-current="page">ระเบียบ</li>
			</ol>
		</nav>
		...
		<section class="pb-4">
			<div class="container">
				<div class="mx-auto mb-5" style="max-width: 1000px;">
					<h4 class="head mb-4 text-center">ระเบียบ</h4>
				...
				<div class="table-responsive">
					<table class="table table-striped text-center">
						...
						<tbody>
							<tr>
								<td class="text-left">ข้อบังคับคณะกรรมการข้อบังคับคณะกรรมการ
									สำนักงานพิพิธภัณฑ์เกษตรเฉลิมพระเกียรติพระบาทสมเด็จพระเจ้าอยู่หัว ว่าด้วยเครื่องแบบพิธีการ
									และเครื่องแบบ
									ปฏิบัติงาน ของสำนักงานพิพิธภัณฑ์เกษตรเฉลิมพระเกียรติพระบาทสมเด็จพระเจ้าอยู่หัว (องค์การมหาชน) พ.ศ.
									2563</td>
								<td>
									<a href="#" download>
							...
							<tr>
								<td class="text-left">
									...
									ประมวลจริยธรรม ของสำนักงาน พ.ศ. 2566</td>
								<td>
									<a href="#" download>
										<img src="../../public/images/icon-pdf.png" style="width: 34px;" alt="">
									</a>
							...
							<tr>
								<td class="text-left">ข้อบังคับคณะกรรมการข้อบังคับคณะกรรมการ
									...
									และขอบเขตหน้าที่ของส่วนงาน พ.ศ. 2566</td>
								<td>
									<a href="#" download>
										<img src="../../public/images/icon-pdf.png" style="width: 34px;" alt="">
									</a>
							...
							<tr>
								<td class="text-left">
									ข้อบังคับคณะกรรมการสำนักงานพิพิธภัณฑ์เกษตรเฉลิมพระเกียรติพระบาทสมเด็จพระเจ้าอยู่หัว
									ว่าด้วยคณะกรรมการตรวจสอบและการตรวจสอบภายใน พ.ศ. 2566</td>
								<td>
									<a href="#" download>
										<img src="../../public/images/icon-pdf.png" style="width: 34px;" alt="">
									</a>
							...
							<tr>
								<td class="text-left">
									...
									ที่ถูกกล่าวหาหรือถูกฟ้องคดีอาญาเนื่องจากการปฏิบัติหน้าที่ พ.ศ. 2565</td>
								<td>
									<a href="#" download>
										<img src="../../public/images/icon-pdf.png" style="width: 34px;" alt="">
									</a>
							...
							<tr>
								<td class="text-left">
									ข้อบังคับคณะกรรมการสำนักงานพิพิธภัณฑ์เกษตรเฉลิมพระเกียรติพระบาทสมเด็จพระเจ้าอยู่หัว
									ว่าด้วยการประนีประนอมยอมความ</td>
								<td>
									<a href="#" download>
										<img src="../../public/images/icon-pdf.png" style="width: 34px;" alt="">
									</a>
							...
							<tr>
								<td class="text-left">
									...
									และการมอบอำนาจให้ผู้อื่นปฏิบัติงานแทนผู้อำนวยการ พ.ศ. 2563</td>
								<td>
									<a href="#" download>
										<img src="../../public/images/icon-pdf.png" style="width: 34px;" alt="">
									</a>
							...
							<tr>
								<td class="text-left">
									ข้อบังคับคณะกรรมการสำนักงานพิพิธภัณฑ์เกษตรเฉลิมพระเกียรติพระบาทสมเด็จพระเจ้าอยู่หัว
									ว่าด้วยการบริหารงานบุคคล พ.ศ. 2563</td>
								<td>
									<a href="#" download>
										<img src="../../public/images/icon-pdf.png" style="width: 34px;" alt="">
									</a>
							...
							<tr>
								<td class="text-left">
									ข้อบังคับคณะกรรมการสำนักงานพิพิธภัณฑ์เกษตรเฉลิมพระเกียรติพระบาทสมเด็จพระเจ้าอยู่หัว
									ว่าด้วยค่าตอบแทนสำหรับคณะบุคคลหรือบุคคลภายนอก พ.ศ. 2563</td>
								<td>
									<a href="#" download>
										<img src="../../public/images/icon-pdf.png" style="width: 34px;" alt="">
									</a>
