	...
	<div id="content" class="content">
		...
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb container bg-white">
				...
				<li class="breadcrumb-item">
					<a href="../knowledge/?param=tab3">สื่อวิดิทัศน์</a>
				</li>
				<li class="breadcrumb-item active" aria-current="page">เส้นทางข้าวไทย</li>
			</ol>
		</nav>
			...
			<div class="container">
				...
				<div class="--detail">
					<div class="box-BGvideo img">
						...
						<img src="https://placehold.co/1000x500" class="w-100" alt="">
					</div>
					...
					<div class="px-lg-5">
						<h4 class="text-center">เส้นทางข้าวไทย</h4>
