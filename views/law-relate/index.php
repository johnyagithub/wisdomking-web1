	...
	<div id="content" class="content">
		...
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb container">
				...
				<li class="breadcrumb-item active" aria-current="page">พระราชบัญญัติ</li>
			</ol>
		</nav>
				...
				<div class="d-flex flex-wrap flex-md-nowrap align-items-start">
					...
					<div class="scale-navTabs ml-auto mb-3">
						<div class="box-navTabs nav nav-tabs ml-auto  mb-auto" role="tablist">
							...
							<button class="nav-link" id="nav-RoyalDecree-tab" data-toggle="tab" data-target="#nav-RoyalDecree"
								type="button" role="tab" aria-controls="nav-RoyalDecree" aria-selected="false">
								พระราชกำหนด
							</button>
							<button class="nav-link" id="nav-decree-tab" data-toggle="tab" data-target="#nav-decree" type="button"
								role="tab" aria-controls="nav-decree" aria-selected="false">
								พระราชกฤษฎีกา
							</button>
						</div>
					</div>
			...
			<div class="container">
				<div class="tab-content">
					<div class="tab-pane fade show active" id="nav-act" role="tabpanel" aria-labelledby="nav-act-tab">
						...
						<p class="text-center">สำนักงานพิพิธภัณฑ์เกษตรเฉลิมพระเกียรติพระบาทสมเด็จพระเจ้าอยู่หัว (องค์การมหาชน)</p>
							...
							<table class="table table-striped text-center">
								...
								<tbody>
									...
									<tr>
										<th class="text-left">
											พระราชกฤษฎีกาจัดตั้งสำนักงานพิพิธภัณฑ์เกษตรเฉลิมพระเกียรติพระบาทสมเด็จพระเจ้าอยู่หัว
											(องค์การมหาชน) (ฉบับที่ 2) พ.ศ. 2562</th>
										<td>
											<a href="#" download="">
												<img src="../../public/images/icon-pdf.png" style="width: 34px;" alt="">
											</a>
									...
									<tr>
										<th class="text-left">พระราชกฤษฎีกา ว่าด้วยหลักเกณฑ์และวิธีการบริหารจัดการบ้านเมืองที่ดี พ.ศ. 2546
										</th>
										<td>
											<a href="#" download="">
												<img src="../../public/images/icon-pdf.png" style="width: 34px;" alt="">
									...
									<tr>
										<th class="text-left">พระราชกฤษฎีกา ว่าด้วยหลักเกณฑ์และวิธีการบริหารกิจการบ้านเมืองที่ดี (ฉบับที่ 2)
											พ.ศ. 2562</th>
										<td>
											<a href="#" download="">
												<img src="../../public/images/icon-pdf.png" style="width: 34px;" alt="">
					...
					<div class="tab-pane fade" id="nav-RoyalDecree" role="tabpanel" aria-labelledby="nav-RoyalDecree-tab">
						<h4 class="head mb-4 text-center">พระราชกำหนด</h4>
						<p class="text-center">สำนักงานพิพิธภัณฑ์เกษตรเฉลิมพระเกียรติพระบาทสมเด็จพระเจ้าอยู่หัว (องค์การมหาชน)</p>
						...
						<div class="table-responsive mt-5">
							<table class="table table-striped text-center">
								...
								<tbody>
									<tr>
										<th class="text-left">พระราชกำหนดว่าด้วยการประชุมผ่านสื่ออิเล็กทรอนิกส์ พ.ศ. 2563</th>
										<td>
											<a href="#" download="">
												<img src="../../public/images/icon-pdf.png" style="width: 34px;" alt="">
											</a>
					...
					<div class="tab-pane fade" id="nav-decree" role="tabpanel" aria-labelledby="nav-decree-tab">
						<h4 class="head mb-4 text-center">พระราชกฤษฎีกา</h4>
						<p class="text-center">สำนักงานพิพิธภัณฑ์เกษตรเฉลิมพระเกียรติพระบาทสมเด็จพระเจ้าอยู่หัว (องค์การมหาชน)</p>
