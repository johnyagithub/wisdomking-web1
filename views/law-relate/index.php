						...
						<div class="table-responsive mt-5">
							<table class="table table-striped text-center">
								...
								<tbody>
									...
									<tr>
										<td class="text-left">พระราชกฤษฎีกา ว่าด้วยหลักเกณฑ์และวิธีการบริหารจัดการบ้านเมืองที่ดี พ.ศ. 2546
										</th>
										<td>
											<a href="#" download="">
												<img src="../../public/images/icon-pdf.png" style="width: 34px;" alt="">
									...
									<tr>
										<td class="text-left">พระราชกฤษฎีกา ว่าด้วยหลักเกณฑ์และวิธีการบริหารกิจการบ้านเมืองที่ดี (ฉบับที่ 2)
											พ.ศ. 2562</th>
										<td>
											<a href="#" download="">
												<img src="../../public/images/icon-pdf.png" style="width: 34px;" alt="">
					...
					<div class="tab-pane fade" id="nav-RoyalDecree" role="tabpanel" aria-labelledby="nav-RoyalDecree-tab">
						...
						<div class="table-responsive mt-5">
							<table class="table table-striped text-center">
								...
								<tbody>
									<tr>
										<td class="text-left">พระราชกำหนดว่าด้วยการประชุมผ่านสื่ออิเล็กทรอนิกส์ พ.ศ. 2563</th>
										<td>
											<a href="#" download="">
												<img src="../../public/images/icon-pdf.png" style="width: 34px;" alt="">
											</a>
