					...
					<div class="col mb-mt-0">
						<div class="border-left">
							<div class="box-navTabs nav nav-tabs ml-auto mb-4 justify-content-center" role="tablist">
								<button class="nav-link border-0 active" id="nav-general-tab" data-toggle="tab"
									data-target="#nav-general" type="button" role="tab" aria-controls="nav-general" aria-selected="true"
									style="box-shadow: none;">
									เรื่องทั่วไป
								</button>
								<button class="nav-link border-0" id="nav-corrupt-tab" data-toggle="tab" data-target="#nav-corrupt"
									type="button" role="tab" aria-controls="nav-corrupt" aria-selected="false" style="box-shadow: none;">
							...
							<div class="tab-content">
								...
								<div class="tab-pane fade" id="nav-corrupt" role="tabpanel" aria-labelledby="nav-corrupt-tab">
									...
									<form action="#">
										<input type="hidden" name="subject" value="ทุจริต และประพฤติมิชอบ">
										<div class="px-xl-4">
											<div class="form-row">
												<div class="form-group col-md-6">
													<label for="input1">ชื่อ (ผู้ร้องเรียน)*</label>
