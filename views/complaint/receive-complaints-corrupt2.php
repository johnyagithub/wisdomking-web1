...
<body>
	...
	<script>
		// active menu
		$('.dropdown-item[href*="receive-complaints-corrupt2.php"]').addClass('active').closest('.dropdown-menu').addClass('show').closest('.dropdown').find('>.dropdown-item').addClass('active');
	</script>
